...
const ApplicationsList = ({ status }) => {
    ...
    // Separate the applications into accepted and rejected lists
    const acceptedApplications = applications.filter(app => app.offer === "accepted");
    const rejectedApplications = applications.filter(app => app.offer === "declined");
                                        ...
                                        <div className="col-md-4" key={app._id}>
                                            <div className="card mb-4">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <p><strong>TA Experience:</strong> {app.experience ? "Yes" : "No"}</p>
                                                    <p><strong>Courses Served as TA:</strong>
                                                        {app.experience && Array.isArray(app.relevant_courses) && app.relevant_courses.length > 0
                                                            ? app.relevant_courses.join(", ")
                                                            : "Not Applicable"}
                                                    </p>
                                                    ...
                                                    {role === 3 && (
                                                        <div className="m-2">
                                                            <button
                                                                ...
                                                                disabled={app.status !== "pending"} // Disable if not pending
                                                            >
                                                                Selected
                                                            </button>
                                                            <button
