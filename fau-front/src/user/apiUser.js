...
export const updateApplicationOffer = async (applicationId, offer) => {
    try {
        const response = await fetch(`${API}/courses/${applicationId}/applications/offerupdate`, {
            method: 'PUT',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
        ...
        if (!response.ok) {
            ...
            throw new Error(error.error || 'Failed to update the offer status.');
        }
